...
#otevrit script (Y\N)
$open = & {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show("Chcete otevřít vytvořený script?", 'Otevření', 'YesNo', [System.Windows.Forms.MessageBoxIcon]::Information);}
if ($open -eq "Yes") {
. .\$OutputName
}
